    ...
    <nav class="navbar navbar-expand-lg  py-4" id="navbar">
        <div class="container">
            <a class="navbar-brand" href="<?php echo base_url(); ?>">
                Mega<span>kit.</span>
<!--                <img src="--><?php //echo base_url('images/logo.png')?><!--" alt="" class="img-fluid">-->
            </a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown03">
                            <li><a class="dropdown-item" href="<?php echo base_url('home/about_us');?>">Our company</a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('home/pricing');?>">Pricing</a></li>
                        </ul>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url('services');?>">Services</a></li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo base_url('login')?>">My Account</a></li>
